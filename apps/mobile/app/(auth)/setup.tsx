  ...
  const onSubmit = handleSubmit((values) =>
    redeem.mutate(values, {
      onSuccess: (householdId) => {
        // Tên nhà và memberId chưa biết ở đây; gate sẽ điền đủ khi
        // `my_households` trả về. Đặt id trước để qua được cổng household.
        setHousehold({ id: householdId, name: '', memberId: '' });
